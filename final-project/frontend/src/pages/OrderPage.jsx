...
function OrderPage() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      setResponseData(data.order)
      setSubmitStatus(data.message || 'Form submitted successfully!')
      setErrors({})
    } catch (error) {
      setSubmitStatus(error.message || 'Something went wrong while sending the form.')
    } finally {
